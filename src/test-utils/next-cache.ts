...
export const mockRevalidatePath = jest.fn().mockImplementation(() => {
...
export const setupCacheFailure = (
  error: Error | string = "Cache revalidation failed"
) => {
...
export const expectCacheWasRevalidatedWithArgs = (expectedArgs: string) => {
